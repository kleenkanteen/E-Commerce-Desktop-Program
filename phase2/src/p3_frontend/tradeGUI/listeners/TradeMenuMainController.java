...
public class TradeMenuMainController implements Initializable {
    ...
    private final String filepath = "/p3_frontend/tradeGUI/fxml_files/MultiTradeItemMenu.fxml";
