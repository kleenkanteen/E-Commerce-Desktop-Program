...
import p3_frontend.tradeGUI.listeners.TradeMenuMainLendController;
...
public class LoanMenu implements Initializable {
    ...
    private final String tradeRunFromLoanFXML = "/p3_frontend/tradeGUI/fxml_files/TradeMenuLend.fxml";
