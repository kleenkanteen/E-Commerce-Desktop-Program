...
import p1_entities.PermTrade;
import exceptions.UserFrozenException;
import p3_frontend.globalInventoryGUI.listeners.MultiItemMenu;
...
public class BrowseThroughUserCollection implements Initializable {
    ...
    // file paths
    private final String multiMenuFXML = "/p3_frontend/globalInventoryGUI/fxml_files/MultiItemMenu.fxml";
