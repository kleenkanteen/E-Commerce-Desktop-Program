package p1_entities;// Written by Thanusun
...
public class PermTrade extends Trade implements Serializable {
     ...
     */
    public PermTrade(String traderA, String traderB, List<p1_entities.Item> userAItemsToTrade, List<Item> userBItemsToTrade, LocalDateTime startDate) {
